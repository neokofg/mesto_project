    ...
    <div class="flex items-center bg-white">
        <div class="mx-auto max-w-[619px]">
            ...
            <div>
                ...
                <p class="text-[18px] font-[400] text-center mt-[4%]">Уже есть аккаунт? <span on:click={login} class="hover:underline cursor-pointer text-blue-500 font-[600]">Войти</span></p>
            </div>
        </div>
    </div>
